...
renderIcon=item.renderIcon;var renderTitle=item.renderTitle;var renderRight=item.renderRight;var disabled=item.disabled;
var isSelected=_this.props.selectedItem===item.id;
var icon=renderIcon&&renderIcon(isSelected,disabled);
var title=renderTitle&&renderTitle(isSelected,disabled);
var rightElement=renderRight&&renderRight(isSelected,disabled);
