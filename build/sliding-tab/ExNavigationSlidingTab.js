...
var TabViewPagerComponent=_reactNative.Platform.OS==='ios'?_reactNativeTabView.TabViewPagerScroll:_reactNativeTabView.TabViewPagerAndroid;var
...
}}]);return ExNavigationSlidingTab;}(_PureComponent3.default),_class.route={__isNavigator:true},_class.navigationBarStyles={borderBottomWidth:0,elevation:0},_class.defaultProps={barBackgroundColor:_ExNavigationBar2.default.DEFAULT_BACKGROUND_COLOR,indicatorStyle:{},position:'top',pressColor:'rgba(0,0,0,0.2)',tabStyle:{},renderBefore:function renderBefore(){return null;}},_class.contextTypes={parentNavigatorUID:_react2.default.PropTypes.string},_class.childContextTypes={parentNavigatorUID:_react2.default.PropTypes.string,navigator:_react2.default.PropTypes.instanceOf(_ExNavigationTab.ExNavigationTabContext)},_initialiseProps=function _initialiseProps(){var _this2=this;this._renderPager=function(props){return _react2.default.createElement(TabViewPagerComponent,_extends({},props,{swipeEnabled:_this2.props.swipeEnabled}));};this._renderScene=function(_ref2){var route=_ref2.route;var tabItem=_this2.state.tabItems.find(function(i){return i.id===route.key;});if(tabItem){return tabItem.element;}else{return null;}};this._renderTabBar=function(props){var TabBarComponent=_this2.props.position==='top'?_reactNativeTabView.TabBarTop:_reactNativeTabView.TabBar;var renderLabelFn=_this2.props.getRenderLabel?_this2.props.getRenderLabel(props):_this2.props.renderLabel;var tabBarProps={pressColor:_this2.props.pressColor,indicatorStyle:_this2.props.indicatorStyle,tabStyle:_this2.props.tabStyle,labelStyle:_this2.props.labelStyle,renderLabel:renderLabelFn,style:[{backgroundColor:_this2.props.barBackgroundColor},_this2.props.tabBarStyle]};return _react2.default.createElement(_reactNative.View,null,_this2.props.renderBefore(),_react2.default.createElement(TabBarComponent,_extends({},props,tabBarProps)));};this._setActiveTab=function(i){var tabItem=_this2.state.tabItems[i];var key=tabItem.id;_this2._getNavigatorContext().jumpToTab(key);if(typeof _this2.props.onChangeTab==='function'){_this2.props.onChangeTab(key);}};},_temp);exports.default=
